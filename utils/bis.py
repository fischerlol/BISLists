...
def values(player_spec, local_file):
    ...
    sets_to_keep = {
        ...
        "".join(hunter_survival_spec): None,
        "".join(shaman_elemental_spec): None,
        "".join(shaman_enhancement_spec): 2,
        "".join(shaman_restoration_spec): 2,
        "".join(warlock_affliction_spec): 2,
        "".join(warlock_demonology_spec): 2,
        "".join(warlock_destruction_spec): 2,
        "".join(paladin_holy_spec): None,
        "".join(paladin_protection_spec): 1,
        "".join(paladin_retribution_spec): None,
        "".join(mage_arcane_spec): None,
        "".join(mage_fire_spec): 1,
        ...
        "".join(druid_feral_bear_spec): None,
        "".join(druid_restoration_spec): None,
        "".join(warrior_arms_spec): 2,
        "".join(warrior_fury_spec): 2,
        "".join(warrior_protection_spec): 2,
        "".join(priest_discipline_spec): 2,
        "".join(priest_holy_spec): 1,
        "".join(priest_shadow_spec): 1,
